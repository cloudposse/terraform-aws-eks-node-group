...
variable "ami_type" {
  ...
  validation {
    condition = (
      contains(["AL2_x86_64", "AL2_x86_64_GPU", "AL2_ARM_64", "BOTTLEROCKET_x86_64", "BOTTLEROCKET_x86_64_NVIDIA", "BOTTLEROCKET_ARM_64", "BOTTLEROCKET_ARM_64_NVIDIA", "WINDOWS_CORE_2019_x86_64", "WINDOWS_CORE_2022_x86_64", "WINDOWS_FULL_2019_x86_64", "WINDOWS_FULL_2022_x86_64", "CUSTOM"], var.ami_type)
    )
    error_message = "Var ami_type must be one of supported types https://docs.aws.amazon.com/eks/latest/APIReference/API_Nodegroup.html."
  }
}
