...
| <a name="detailed_monitoring_enabled"></a> [detailed\monitoring\_enabled](#input\_detailed\_monitoring\_enabled) | Set true to enable the detailed monitoring on the EC2 nodes | `bool` | `false` | no |
