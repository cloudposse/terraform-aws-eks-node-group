...
This will be updated later. However, the documentation on this
page about inputs, output, and compliance is all automatically generated
and is up-to-date. Also, the [examples/complete](examples/complete) is
automatically tested before every release, so that is a good place
