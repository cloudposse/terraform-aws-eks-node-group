...
| <a name="input_cluster_cidr"></a> [cluster\_cidr](#input\_cluster\_cidr) | The CIDR block to assign Kubernetes pods.<br>Terraform will only perform drift detection if a configuration value is provided. | `string` | `null` | no |
