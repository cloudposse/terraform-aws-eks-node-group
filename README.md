...
| <a name="input_cluster_cidr"></a> [cluster\_cidr](#input\_cluster\_cidr) | The CIDR block of cluster.<br>This will be pass to nodeadm with `AL2023_x86_64_STANDARD` and `AL2023_ARM_64_STANDARD` AMI types.<br>If not set, VPC CIDR Block will be used. | `string` | `null` | no |
